...
function medsites_scripts() {
	...
	// wp_enqueue_script( 'popper', get_template_directory_uri(). '/src/js/popper.js', false ,'', true );
	
	// wp_enqueue_script( 'popper', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.6/popper.min.js',  array(), true );
	// wp_enqueue_script( 'popper');


	wp_enqueue_script( "medsites-tether-js", get_template_directory_uri() . "/src/js/tether.min.js", array(), 20171109, true );
	wp_enqueue_script( "medsites-bo-js", get_template_directory_uri() . "/src/js/bootstrap.min.js", array('jquery', 'Popper'), 20171109, true );
	...
	wp_enqueue_script( 'medsites-skip-link-focus-fix', get_template_directory_uri() . '/src/js/skip-link-focus-fix.js', array(), '20151215', true );
