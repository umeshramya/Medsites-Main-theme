...
function medsites_scripts() {
	...
	// wp_register_script( 'popper', get_template_directory() . '/src/js/popper.js', array(), true );
	wp_register_script( 'popper', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.6/popper.min.js', false, '', true );
	...
	// /var/www/html/wordpress/wp-content/themes/Medsites-Main-theme/src/js/skip-link-focus-fix.js
